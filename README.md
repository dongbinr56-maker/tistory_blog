...
2. `View`에서 이미지·본문·원문 링크를 확인하고, **작성자 코멘트(60자 이상)를 직접 작성**합니다. 자신의 경험이나 판단 한 문단이 없으면 복사 버튼이 동작하지 않으며, 코멘트는 복사되는 본문의 도입부 아래에 삽입됩니다.
...
- 자동 생성 글의 무검토 게시 금지(`manual_review_required: true`) 및 발행 전 작성자 코멘트 직접 작성 필수
